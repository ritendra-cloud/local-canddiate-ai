...
class Settings(BaseSettings):
    ...
    ollama_chat_model: str | None = None; ollama_job_match_model: str = 'gemma4:e4b-mlx'
    ...
    job_match_num_ctx: int = 16384; job_match_num_predict: int = 2048; job_match_temperature: float = 0; job_match_requirement_batch_size: int = 4
