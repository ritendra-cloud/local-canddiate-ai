...
def public_config(): return {'application_name':settings.app_name,'local_only':True,'configured_model':settings.ollama_model,'max_user_message_length':settings.max_user_message_length,'max_job_description_length':settings.max_job_description_length}
