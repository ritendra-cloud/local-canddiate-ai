...
class JobMatchRequest(BaseModel):
    ...
    def nonempty(cls,v):
        ...
        return v
class JobRequirementMatch(BaseModel): requirement:str; category:Category; importance:Importance; match_status:MatchStatus; evidence_refs:list[str]=[]; explanation:str; confidence:Confidence; gap_classification:GapClassification|None=None
